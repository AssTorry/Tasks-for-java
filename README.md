...
Вам потребуется реализовать интерфейс [Percolation](src/main/java/domain/Percolation.java).
...
Вам потребуется реализовать интерфейс [PercolationStats](src/main/java/domain/PercolationStats.java).

### Перед началом убедиться, что проект запускается :
Зайди в [Main](src/main/java/Main.java) - если все ок, то должна появиться зеленая стрелочка
возле `public static void main(String[] arg){`
